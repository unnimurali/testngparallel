...
public class FirstTest extends Testbase {
	...
	public void GOOGLE1() throws Exception {
		...
		System.out.println(
				"Google1 Test's Page title is: " + getDriver().getTitle() + " " + Thread.currentThread().getId());
	...
	public void GOOGLE2() throws Exception {
		...
		getDriver().navigate().to("http://www.google.com");
		System.out.println(
				"Google2 Test's Page title is: " + getDriver().getTitle() + " " + Thread.currentThread().getId());
		Assert.assertEquals(getDriver().getTitle(), "Google");
	...
	public void GOOGLE3() throws Exception {
		...
		getDriver().navigate().to("http://www.google.com");
		System.out.println(
				"Google3 Test's Page title is: " + getDriver().getTitle() + " " + Thread.currentThread().getId());
		Assert.assertEquals(getDriver().getTitle(), "Google");
